                                        ...
                                        <div class="card-inner">
                                            <div style="text-align: right;" class="card-title-group align-start mb-0">
                                                <div class="card-title">
                                                    ...
                                                    <span style="font-size: 54px;font-weight: bold;color:#364a63;" class="amount arab">
                                        ...
                                        <div class="card-inner">
                                            <div style="text-align: right;" class="card-title-group align-start mb-0">
                                                <div class="card-title">
                                                    ...
                                                    <span style="font-size: 54px;color: #364a63;font-weight: bold;color:#364a63;" class="amount arab">
                                                        {{ \App\Models\Carriere::count() }}
                                                    </span>
                                                </div>
                                                <div style="width:30%;" class="card-tools">
                                    ...
                                    <div class="card card-bordered h-100">
                                        ...
                                        <div class="nk-tb-list is-loose">
                                            <div class="nk-tb-item nk-tb-head">
                                                ...
                                                <div class="nk-tb-col text-right"><span>{{auth()->user()->full_name}}</span></div>

                                                <div style="font-size: 15px;font-weight: bold;" class="nk-tb-col"><span>بريد الالكتروني</span></div>
                                                <div class="nk-tb-col tb-col-sm text-right"><span>{{auth()->user()->email}}</span></div>
                                                <div style="font-size: 15px;font-weight: bold;" class="nk-tb-col"><span>عنوان</span></div>
                                                <div class="nk-tb-col tb-col-sm text-right"><span>{{\App\Models\Acceuil::where('user_id',auth()->user()->id)->first()->address}}</span></div>
                                                <div style="font-size: 15px;font-weight: bold;" class="nk-tb-col"><span>الهاتف</span></div>
                                                <div class="nk-tb-col tb-col-sm text-right"><span>{{\App\Models\Acceuil::where('user_id',auth()->user()->id)->first()->tel1}}</span></div>
                                                <div style="font-size: 15px;font-weight: bold;" class="nk-tb-col"><span>تاريخ الميلاد</span></div>
                                                <div class="nk-tb-col tb-col-sm text-right"><span>{{\App\Models\Acceuil::where('user_id',auth()->user()->id)->first()->date_naissance}}</span></div>
                                            </div><!-- .nk-tb-head -->
