                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <div class="nk-block-head-sub"><a class="back-to" ><em class="icon ni ni-arrow-left"></em><span>Tous Les Moduls</span></a></div>
                                <h2 class="nk-block-title fw-normal"><em class="bi bi-bounding-box"></em> Edit Moduls</h2>
                    ...
                    <div class="nk-block">
                        <div class="card card-stretch">
                            <div class="card-inner-group">
                                ...
                                <div class="card card-preview" style="padding: 16px">


                                    <form action="{{ route('model.update',$model->id) }}" method="POST" enctype="multipart/form-data" class="pt-2">
                                        @csrf
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" value="{{$model->title}}" id="course-name" name="model_name" placeholder="Nom du cours">
                                                    </div>
                                                </div><!-- .form-group -->
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <select class="form-select" id="course-category" name="coure_id">
                                                            @isset($cources)
                                                                @foreach($cources as $coure)
                                                                    <option @if($model->coure_id == $coure->id) selected @endif value="{{ $coure->id }}">{{ $coure->cours_name }}</option>
