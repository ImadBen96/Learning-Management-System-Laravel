                                            ...
                                            @if( count($data) > 0 )
                                                <div class="nk-tb-list">
                                                    <div class="nk-tb-item nk-tb-head">
                                                        ...
                                                        <div class="nk-tb-col font-weight-bold"><h6>Action</h6></div>
                                                    </div><!-- .nk-tb-item -->
                                                    @foreach( $data as $d)
                                                        <div class="nk-tb-item vid" data-url="{{ url( str_replace('public','storage',$d["url"]) ) }}">
                                                            ...
                                                            <div class="nk-tb-col">
                                                                <span class="tb-sub">
                                                                     <a href="{{ route('videos.delete',$d['id']) }}"><span>Supprimée La Video</span></a>
