                        ...
                        <div class="nk-block nk-block-lg">
                            ...
                            <div class="card card-bordered">
                                <div class="card-inner">
                                    <form action="{{ route('student.update',$acceils->id) }}" method="POST" id="send_forms" enctype="multipart/form-data" class="nk-wizard nk-wizard-simple is-alter" >
                                        @csrf
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="avatar-upload">
                                                        ...
                                                        <div class="avatar-preview">
                                                            @if($acceils->image_profile)
                                                                <div id="imagePreview"
                                                                     style="background-image: url({{ asset('images/acceuil/'.$acceils->image_profile) }});">
                                                            @else
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" data-msg="Obligatoire" class="form-control required" value="{{$acceils->first_name}}" id="fw-first-name" name="first_name" required>
                                                        </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" data-msg="Obligatoire" class="form-control required" id="fw-last-name" value="{{$acceils->last_name}}" name="last_name" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text"  class="form-control"  id="fw-nationality" value="{{$acceils->nationality}}" name="nationality" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                <input type="radio" class="custom-control-input required"
                                                                       @if($acceils->genre == 'Homme') checked @endif

                                                                       data-msg="Obligatoire" name="genre" id="btnIconRadio1" value="Homme" />
                                                                <label class="custom-control-label" for="btnIconRadio1">
                                                                    <img width="26" src="{{ asset('images/man.png') }}" /><span>Homme</span></label>
                                                            </div>
                                                            <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                <input type="radio" class="custom-control-input required"
                                                                       @if($acceils->genre == 'Femme') checked @endif
                                                                       name="genre" id="btnIconRadio2" value="Femme" />
                                                                <label class="custom-control-label" for="btnIconRadio2">
                                                                    <img width="26" src="{{ asset('images/woman.png') }}" /><span>Femme</span></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text"  name="date_naissance" data-msg="Obligatoire" class="form-control date-picker required" value="{{$acceils->date_naissance}}" id="date-de-naissance" data-date-format="yyyy-mm-dd">
                                                        </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" class="form-control" id="lieu-de-naissance" name="lieu_naissance" value="{{$acceils->lieu_naissance}}" />
                                                        </div>
                                                            ...
                                                            <ul class="custom-control-group">
                                                                <li>
                                                                    <div class="custom-control custom-control-sm custom-radio" >
                                                                        <input type="radio"
                                                                               @if($acceils->territoire ==  'Province Nouaceur') checked @endif
                                                                               id="customRadio1" name="territoire"class="custom-control-input required" data-msg="Obligatoire" value="Province Nouaceur" />
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-control-sm custom-radio">
                                                                        <input type="radio" id="customRadio2"
                                                                               @if($acceils->territoire == "autre_province") checked @endif
                                                                               name="territoire"  class="custom-control-input" value="autre_province" />
                                                                        <label class="custom-control-label" for="customRadio2">Autre Préfecture/Province</label>
                                                                    </div>
                                                                </li>
                                                                <li @if($acceils->territoire == "autre_province") style=" display:block;" @else style=" display:none;" @endif  class="autre_province">
                                                                    <input type="text" name="autre_province" class="form-control" id="autre_province_accept" value="{{$acceils->autre_province}}"  />
                                                                </li>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <div class="input-group">
                                                                ...
                                                                <textarea class="form-control" id="address" name="address" aria-label="With textarea">{{$acceils->address}}</textarea>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" data-msg="Obligatoire" class="form-control required" value="{{$acceils->cin}}" id="cin" name="cin" />
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="number" data-msg="Obligatoire" value="{{$acceils->tel1}}" class="form-control required" id="tel1" name="tel1" />
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="email" data-msg="Required" value="{{$acceils->email1 }}" class="form-control" id="email1" name="email1" />
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="number" data-msg="Required" class="form-control" value="{{$acceils->tel2}}" id="tel2" name="tel2" />
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <ul class="custom-control-group">
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="checkbox" class="custom-control-input" name="connu_notre_service[]"
                                                                               @if(Illuminate\Support\Str::contains($acceils->connu_notre_service, 'par_Un_ami')) checked  @endif id="ami" value="par_Un_ami" />
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="checkbox" class="custom-control-input" name="connu_notre_service[]"
                                                                               @if(Illuminate\Support\Str::contains($acceils->connu_notre_service, 'Par_le_bouche_oreille')) checked  @endif
                                                                               id="oreille" value="Par_le_bouche_oreille" />
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="checkbox" class="custom-control-input"
                                                                               @if(Illuminate\Support\Str::contains($acceils->connu_notre_service, 'par_la_famille')) checked  @endif
                                                                               name="connu_notre_service[]" id="famille" value="par_la_famille" />
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="checkbox" class="custom-control-input" name="connu_notre_service[]"
                                                                               @if(Illuminate\Support\Str::contains($acceils->connu_notre_service, 'sur_Internet')) checked  @endif
                                                                               id="Internet" value="sur_Internet" />
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="checkbox" class="custom-control-input" name="connu_notre_service[]"
                                                                               @if(Illuminate\Support\Str::contains($acceils->connu_notre_service, 'par_le_biais_une_association')) checked  @endif
                                                                               id="association" value="par_le_biais_une_association" />
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="checkbox" class="custom-control-input"
                                                                               @if(Illuminate\Support\Str::contains($acceils->connu_notre_service, 'agent_de_mobilisation')) checked  @endif
                                                                               name="connu_notre_service[]" id="agent" value="agent_de_mobilisation" />
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="checkbox" class="custom-control-input" name="connu_notre_service[]"
                                                                               @if(Illuminate\Support\Str::contains($acceils->connu_notre_service, 'laureat_Ambassadeur')) checked  @endif
                                                                               id="ambassadeur" value="laureat_Ambassadeur">
                                                                        <label class="custom-control-label" for="ambassadeur">Lauréat / Ambassadeur </label>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="checkbox" class="custom-control-input autre"
                                                                               @if(Illuminate\Support\Str::contains($acceils->connu_notre_service, 'Autre')) checked  @endif
                                                                               name="connu_notre_service[]" id="Autre" value="Autre">
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="checkbox" class="custom-control-input autre_service"
                                                                               @if(Illuminate\Support\Str::contains($acceils->connu_notre_service, 'autre_service')) checked  @endif
                                                                               name="connu_notre_service_autre" id="Autre" value="">

                                                                    </div>
                                                                </li>
                                                                <li @if(Illuminate\Support\Str::contains($acceils->connu_notre_service, 'autre_service')) style="display: block;" @else style="display: none;"  @endif  class="connu_notre_service_autre">
                                                                    <input type="text"  class="form-control" placeholder="Autre" id="connu_notre_service_autre" name="connu_notre_service_autre" value="{{$acceils->connu_notre_service_autre}}" />
                                                                </li>
                                            ...
                                            <div class="row gy-3">
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="number"  class="form-control" id="membres_de_famille"
                                                                   value="{{$acceils->membres_de_famille}}"
                                                                   name="membres_de_famille" />
                                                        </div>
                                                    </div>
                                                </div><!-- .col -->
                                                <div class="col-md-7">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="number" class="form-control" value="{{$acceils->membres_de_famille}}" id="fw-username" name="personnes_ayant_une_activite_salariale" />
                                                        </div>
                                                    </div>
                                                </div><!-- .col -->
                                                        ...
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <ul class="custom-control-group">
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="radio" class="custom-control-input"
                                                                               @if($acceils->ressources == 'Ressources_propres') checked  @endif
                                                                               name="ressources" id="Ressources" value="Ressources_propres" />
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="radio" class="custom-control-input"
                                                                               @if($acceils->ressources == 'Pris_en_charge_par_les_parents') checked  @endif
                                                                               name="ressources" id="parents" value="Pris_en_charge_par_les_parents" />
                                                                        <label class="custom-control-label" for="parents">Pris en charge par les parents</label>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="radio" class="custom-control-input autre_ressources"
                                                                               @if($acceils->ressources == 'Autre') checked  @endif
                                                                               name="ressources" id="autre_ressources" value="Autre">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <ul class="custom-control-group">
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="radio" class="custom-control-input"
                                                                               @if($acceils->situation_familiale == 'Celibataire') checked  @endif
                                                                               name="situation_familiale" id="Celibataire" value="Celibataire" />
                                                                        <label class="custom-control-label" for="Celibataire">Célibataire</label>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="radio" class="custom-control-input" name="situation_familiale"
                                                                               @if($acceils->situation_familiale == 'Marie_Nombre_denfants') checked  @endif
                                                                               id="Marie" value="Marie_Nombre_denfants" />
                                                                        <label class="custom-control-label" for="Marie">Marié(e) Nombre d’enfants</label>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="radio" class="custom-control-input" value="Divorce"
                                                                               @if($acceils->situation_familiale == 'Divorce') checked  @endif
                                                                               name="situation_familiale" id="Divorce">
                                                                        <label class="custom-control-label" for="Divorce">Divorcé(e)</label>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="radio" class="custom-control-input" value="Veuf"
                                                                               @if($acceils->situation_familiale == 'Veuf') checked  @endif
                                                                               name="situation_familiale" id="Veuf">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <ul class="custom-control-group">
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="radio" class="custom-control-input"
                                                                               @if($acceils->situation_familiale == 'Locataire') checked  @endif
                                                                               value="Locataire" name="logement" id="locataire">
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="radio" class="custom-control-input"
                                                                               @if($acceils->situation_familiale == 'Proprietaire') checked  @endif
                                                                               name="logement" value="Proprietaire" id="proprietaire">
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="checkbox" class="custom-control-input"
                                                                               @if($acceils->situation_familiale == 'Bidonville') checked  @endif
                                                                               value="Bidonville" name="logement" id="bidonville">
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="checkbox" class="custom-control-input"
                                                                               @if($acceils->situation_familiale == 'Autres') checked  @endif
                                                                               name="logement" value="Autres" id="autres_Logement">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <ul class="custom-control-group">
                                                                <li>
                                                                    <div class="custom-control custom-control-sm custom-radio">
                                                                        <input type="radio" id="handicap_oui"
                                                                               @if($acceils->handicap_quelconque == 'OUI') checked  @endif
                                                                               name="handicap_quelconque" class="custom-control-input" value="OUI" />
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-control-sm custom-radio">
                                                                        <input type="radio" id="handicap_non" name="handicap_quelconque"
                                                                               @if($acceils->handicap_quelconque == 'NON') checked  @endif
                                                        ...
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <ul class="custom-control-group">
                                                                <li>
                                                                    <div class="custom-control  custom-checkbox custom-control-pro no-control">
                                                                        <input type="radio" class="custom-control-input"
                                                                               @if($acceils->type_de_handicap == 'Physique') checked  @endif
                                                                               name="type_de_handicap" id="Physique" value="Physique" />
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="radio" class="custom-control-input"
                                                                               @if($acceils->type_de_handicap == 'Sensoriel') checked  @endif
                                                                               name="type_de_handicap" value="Sensoriel" id="Sensoriel">
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="radio" class="custom-control-input"
                                                                               @if($acceils->type_de_handicap == 'Mental') checked  @endif
                                                                               name="type_de_handicap" value="Mental" id="Mental">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <ul class="custom-control-group">
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="radio" class="custom-control-input"
                                                                               @if($acceils->cause_du_handicap == 'Naissance') checked  @endif
                                                                               name="cause_du_handicap" id="Naissance" value="Naissance" />
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="radio" class="custom-control-input"
                                                                               @if($acceils->cause_du_handicap == 'Accident') checked  @endif
                                                                               value="Accident" name="cause_du_handicap" id="Accident">
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="radio" class="custom-control-input"
                                                                               @if($acceils->cause_du_handicap == 'Maladie') checked  @endif
                                                                               value="Maladie" name="cause_du_handicap" id="Maladie">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <ul class="custom-control-group">
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="radio" class="custom-control-input"
                                                                               @if($acceils->mobilite == 'Deplacement_sans_aide') checked  @endif
                                                                               name="mobilite" id="Deplacement" value="Deplacement_sans_aide" />
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="radio" class="custom-control-input"
                                                                               @if($acceils->mobilite == 'Possibilite_de_travailler_debout') checked  @endif
                                                                               name="mobilite" id="Possibilite" value="Possibilite_de_travailler_debout" />
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="radio" class="custom-control-input"
                                                                               ...
                                                                               @if($acceils->mobilite == 'Possibilite_de_monter_des_escaliers') checked  @endif
                                                                               value="Possibilite_de_monter_des_escaliers" name="mobilite" id="escaliers" />
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <ul class="custom-control-group">
                                                                <li>
                                                                    <div class="custom-control custom-control-sm custom-radio">
                                                                        <input type="radio" id="maladie_oui"
                                                                               @if($acceils->maladie_chronique == 'OUI') checked @endif
                                                                               name="maladie_chronique" class="custom-control-input maladie_oui" value="OUI" />
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-control-sm custom-radio">
                                                                        <input type="radio" id="maladie_non"  name="maladie_chronique"
                                                                               @if($acceils->maladie_chronique == 'NON') checked @endif
                                                                               class="custom-control-input" value="NON" />
                                                                        <label class="custom-control-label" for="maladie_non">NON</label>
                                                                    </div>
                                                                </li>
                                                                <li class="maladie_chronique"   @if($acceils->maladie_chronique == 'OUI') style="display: block;" @else  style="display: none;" @endif >
                                                                    <input type="text" class="form-control" id="maladie_chronique_accept"  value="{{$acceils->maladie_chronique_oui}}" name="maladie_chronique_oui" />
                                                                </li>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <ul class="custom-control-group">
                                                                <li>
                                                                    <div class="custom-control custom-control-sm custom-radio">
                                                                        <input type="radio" id="rendement_travail_oui"
                                                                               @if($acceils->rendement_travail == 'OUI') checked @endif
                                                                               name="rendement_travail" class="custom-control-input" value="OUI" />
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-control-sm custom-radio">
                                                                        <input type="radio" class="custom-control-input"
                                                                               @if($acceils->rendement_travail == 'NON') checked @endif
                                                                               name="rendement_travail" id="rendement_travail_non" value="NON" />
                                                                        <label class="custom-control-label" for="rendement_travail_non">Non</label>
                                                                    </div>
                                                                </li>
                                                                <li class="rendement_travail" @if($acceils->rendement_travail == 'OUI') style="display: block;" @else style="display: none" @endif >
                                                                    <input type="text" class="form-control" id="rendement_travail_accept" value="{{$acceils->rendement_travail_oui}}" name="rendement_travail_oui" />
                                                                </li>
                                            ...
                                            <div class="row gy-2">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <ul class="custom-control-group">
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="radio" class="custom-control-input"
                                                                               @if($acceils->niveau_scolaire == 'Aucune') checked @endif
                                                                               name="niveau_scolaire" value="Aucune" id="Aucune">
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="radio" class="custom-control-input"
                                                                               @if($acceils->niveau_scolaire == 'Niveau_primaire') checked @endif
                                                                               value="Niveau_primaire" name="niveau_scolaire" id="primaire">
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="radio" class="custom-control-input"
                                                                               @if($acceils->niveau_scolaire == 'Fin_de_parcours_scolaire') checked @endif
                                                                               value="Fin_de_parcours_scolaire" name="niveau_scolaire" id="scolaire">
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="radio" class="custom-control-input"
                                                                               @if($acceils->niveau_scolaire == 'Niveau_college') checked @endif
                                                                               value="Niveau_college" name="niveau_scolaire" id="college">
                                                                        <label class="custom-control-label" for="college">Niveau collège</label>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="radio" class="custom-control-input"
                                                                               @if($acceils->niveau_scolaire == 'Niveau_lycee') checked @endif
                                                                               value="Niveau_lycee" name="niveau_scolaire" id="lycee">
                                                                        <label class="custom-control-label" for="lycee">Niveau lycée</label>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="radio" class="custom-control-input"
                                                                               @if($acceils->niveau_scolaire == 'En_cours_de_formation') checked @endif
                                                                               value="En_cours_de_formation" name="niveau_scolaire" id="en_cours__formation">
                                                                        <label class="custom-control-label" for="en_cours__formation">En cours de formation</label>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                        <input type="radio" class="custom-control-input avec_diplome"
                                                                               @if($acceils->niveau_scolaire == 'Avec_diplome') checked @endif
                                                                               value="Avec_diplome" name="niveau_scolaire" id="avec_diplome">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <ul class="custom-control-group">
                                                                <li>
                                                                    <div class="custom-control custom-control-sm custom-radio">
                                                                        <input type="radio" id="employabilite" name="oriente_vers"
                                                                               @if($acceils->oriente_vers == 'employabilite') checked @endif
                                                                               class="custom-control-input" value="employabilite">
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-control-sm custom-radio">
                                                                        <input type="radio" id="entrepreneuriat" name="oriente_vers"
                                                                               @if($acceils->oriente_vers == 'entrepreneuriat') checked @endif
                                                                               class="custom-control-input" value="entrepreneuriat">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control valid" value="{{$acceils->objectif_professionnel}}" id="objectif_professionnel" name="objectif_professionnel" aria-invalid="false">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <ul class="custom-control-group">
                                                                <li>
                                                                    <div class="custom-control custom-control-sm custom-radio">
                                                                        <input type="radio" id="souhait_formation_oui"
                                                                               @if($acceils->souhait_formation == 'OUI') checked @endif
                                                                               name="souhait_formation" class="custom-control-input" value="OUI">
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-control-sm custom-radio">
                                                                        <input type="radio" id="souhait_formation_non"
                                                                               @if($acceils->souhait_formation == 'NON') checked @endif
                                                                               name="souhait_formation" class="custom-control-input" value="NON">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <ul class="custom-control-group">
                                                                <li>
                                                                    <div class="custom-control custom-control-sm custom-radio">
                                                                        <input type="radio" id="disponible_oui"
                                                                               @if($acceils->disponible == 'OUI') checked @endif
                                                                               name="disponible" class="custom-control-input" value="OUI">
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-control-sm custom-radio">
                                                                        <input type="radio" id="disponible_non"
                                                                               @if($acceils->disponible == 'NON') checked @endif
                                                                               name="disponible" class="custom-control-input" value="NON">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                           value="{{ \App\Models\User::find($acceils->user_id)->email }}"
                                                                           name="email" id="default-01" placeholder="Email">
                                                                </div>
                                                            </div>
